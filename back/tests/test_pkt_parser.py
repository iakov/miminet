...
class TestIsIPv4Address:
    ...
    def test_valid_addresses(self):
        ...
        for addr in valid:
            assert is_ipv4_address(addr), f"Failed for {addr}"
    ...
    def test_boundary_values(self):
        ...
        assert is_ipv4_address("256.255.255.255")
        assert is_ipv4_address("0.0.0.256")
...
class TestIsDHCP:
    ...
    def test_dhcp_packet_discover(self):
        ...
        dhcp.opts = [(dpkt.dhcp.DHCP_OPT_MSGTYPE, bytes([dpkt.dhcp.DHCPDISCOVER]))]
